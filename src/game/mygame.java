...
//            int hitted_count = items[1];
            if ((yulei_left == 12) && (youxiang_left) > 0) {
                ...
                System.out.println("丢盔弃甲的你被愤怒的GOD executed，possible mission failed!\nshame!shame!shame!\n******是非成败转头空，多少英雄事都付笑谈中！******");
                break;
            } else if (youxiang_left == 0) {
                System.out.println("敌船被击沉！Impossible mission completed!今晚吃鸡！");
                System.out.println(String.format("但是你总共浪费了%d颗鱼雷，******无功无过，平平无奇。******", (18 - 3 - yulei_left)));
                break;
            }
        }
    }
